...
This project is indexed by GitNexus as **openai-realtime-agents** (1264 symbols, 1619 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
